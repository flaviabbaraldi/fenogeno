<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="Fenogeno.WebUI.Cadastro" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Label ID="lblArquivo" runat="server" CssClass="control-label">Foto:</asp:Label>
